...
match depth with
  ...
  | _ -> match rand(2,9) with
          ...
          | 4 -> buildTimes(build2(rand, depth-1),build2(rand, depth-1))
          ...
          | 7 -> buildSqroot(build2(rand, depth-1))
          | 8 -> buildTimesAdd(build2(rand, depth-1),build2(rand, depth-1),build2(rand, depth-1))
